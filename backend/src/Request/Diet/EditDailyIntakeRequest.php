...
class EditDailyIntakeRequest extends BaseRequest
{
    #[NotBlank]
    #[NotNull]
    #[ConstraintExistsInDatabase(field: 'id', entityClass: DailyIntake::class, message: 'La toma diaria seleccionada no existe')]
