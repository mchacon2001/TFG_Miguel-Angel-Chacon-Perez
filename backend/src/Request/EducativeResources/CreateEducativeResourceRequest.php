...
class CreateEducativeResourceRequest extends BaseRequest
{
    ...
    public function validate(): void
    {
        ...
        $checkEducativeResourceName = $this->educativeResourceService->getEducativeResourceByName($this->title);

        if($checkEducativeResourceName)
        {
            $this->addError('title', 'Ya existe un recurso educativo con el título introducido');
            $this->resolveRequest();
        }
    }
}