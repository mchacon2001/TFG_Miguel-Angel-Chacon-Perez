...
class DeleteRoutineCategoryRequest extends BaseRequest
{
    #[NotBlank]
    #[NotNull]
    #[ConstraintExistsInDatabase(field: 'id', entityClass: RoutineCategory::class, message: 'La categoria de rutina no existe en la base de datos')]
    ...
    public function validate(): void
    {
        ...
        $routineCategory = $this->routineService->getRoutineCategoryByIdSimple($this->routineCategoryId);
