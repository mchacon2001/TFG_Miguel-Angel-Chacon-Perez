...
class EditRoutineRegisterRequest extends BaseRequest
{
    #[NotBlank]
    #[NotNull]
    #[ConstraintExistsInDatabase(
        entityClass: RoutineRegisterService::class,
        field: 'id',
        message: 'El registro de rutina especificado no existe'
    )]
