...
class EditUserHasRoutineRequest extends BaseRequest
{
    #[NotBlank]
    #[NotNull]
    #[ConstraintExistsInDatabase(field: 'id', entityClass: UserHasRoutine::class, message: 'La rutina del usuario seleccionada no existe')]
