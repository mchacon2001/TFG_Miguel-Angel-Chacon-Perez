...
class RemoveRoleUserRequest extends BaseRequest
{
    #[NotBlank]
    #[NotNull]
    #[Uuid]
    ...
    #[NotBlank]
    #[NotNull]
    #[ConstraintExistsInDatabase(field: 'id', entityClass: UserHasRole::class, message: "El permiso del usuario no existe en la base de datos")]
